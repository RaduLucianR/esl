...
#define MAX_SHARED_SIZE (VEP_MEMSHARED0_SHARED_REGION_SIZE / 2 - 20)
...
typedef volatile struct {
  ...
  token_24_t buffer_in1[BUFFER_SIZE_RGB];
  token_24_t buffer_in2[BUFFER_SIZE_RGB];
  token_t buffer_out1[BUFFER_SIZE];
  token_t buffer_out2[BUFFER_SIZE];

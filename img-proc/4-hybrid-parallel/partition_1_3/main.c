...
#define OUTPUT (&vep_tile1_partition3_shared_region->fifo)
#define BUFFER (vep_tile1_partition3_shared_region->buffer)
#define I_BUFFER (vep_tile1_partition3_shared_region->i_buffer)
...
int main()
{
  xil_printf("Convolution bottom running\n");
  ...
  while(1)
  {
    ...
    xil_printf("Convolution bottom new image\n");
    ...
    xil_printf("Convolution bottom done\n");
    while (MEM->sync == 1);
  }

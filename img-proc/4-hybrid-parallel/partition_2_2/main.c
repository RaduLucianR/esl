...
#define INPUT  (&vep_tile1_partition3_shared_region->fifo)
#define OUTPUT (&vep_tile2_partition2_shared_region->fifo)
#define BUFFER (vep_tile2_partition2_shared_region->buffer)
#define I_BUFFER (vep_tile2_partition2_shared_region->i_buffer)
...
int main()
{
  xil_printf("Sobel bottom running\n");
  ...
  while(1)
  {
    ...
    xil_printf("Sobel bottom new image\n");
